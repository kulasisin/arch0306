...
async function main() {
  ...
  //依序發問
  let answers = {};
  answers.yourName = await question("歡迎來到故事小舖，你的名字是甚麼呢？");
  ...
  const storyTemplate = [
    `\n\n\n在一個  \x1b[1;31m${answers.yourAdj}\x1b[m  清晨，在某個  \x1b[1;33m${answers.yourLoc}\x1b[m  的角落，  \x1b[1;33m${answers.yourName}  靜靜地盯著遠方的動物。它的  \x1b[1;33m${answers.yourAdj}  眼睛閃爍著思考的光芒，而身邊的 \x1b[1;33m${answers.yourNoun}  伙伴則在  \x1b[1;33m${answers.yourAdv}  並輕快地跳躍著。這個 \x1b[1;33m${answers.yourNoun}\x1b[m 生物沐浴在 \x1b[1;33m${answers.yourAdj}\x1b[m 陽光下，享受著每一刻的寧靜。時間彷彿在這裡凝固，留下了一幅永恆的畫面。\n\n\n`,
    ` \x1b[1;33m${answers.yourName}\x1b[m 在一個炎熱的 \x1b[1;33m${answers.yourTime}\x1b[m ，發現在 \x1b[1;31m${answers.yourLoc}\x1b[m 中，突然出現了一座 \x1b[1;33m${answers.yourAdj}\x1b[m \x1b[1;33m${answers.yourNoun}\x1b[m 。 \x1b[1;33m${answers.yourNoun}\x1b[m 散發著陣陣涼意，而周圍的人們則在熱浪中 \x1b[1;33m${answers.yourAdv}\x1b[m 翻滾。 \x1b[1;33m${answers.yourName}\x1b[m 用力拍打 \x1b[1;33m${answers.yourNoun}\x1b[m 。這個離奇的 \x1b[1;33m${answers.yourAdj}\x1b[m 景象讓人們不禁驚嘆大自然的神奇，仿佛置身於一個奇幻的冰雪世界中。\n\n\n`,
